...
MELCOW_VID = environ.get("MELCOW_VID", "https://t.me/how_to_open0")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001580783761').split()]
...
SHORTLINK_API = environ.get('SHORTLINK_API', '18af828b2c1e9f3851a61df1137a4a2cba0244e2')
...
URL = "https://movie-pgum.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://movie-pgum.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://movie-pgum.onrender.com/".format(FQDN)
else:
    URL = "https://movie-pgum.onrender.com/".format(FQDN)
