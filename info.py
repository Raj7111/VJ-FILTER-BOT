...
URL = "https://ziyabot.vercel.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://ziyabot.vercel.app//".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://ziyabot.vercel.app//".format(FQDN)
else:
    URL = "https://ziyabot.vercel.app//".format(FQDN)
