...
URL = "https://ziyamovie.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://ziyamovie.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://ziyamovie.onrender.com/".format(FQDN)
else:
    URL = "https://ziyamovie.onrender.com/".format(FQDN)
