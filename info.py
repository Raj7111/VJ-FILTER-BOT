...
URL = "https://ziyamovie-e99l.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://ziyamovie-e99l.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://ziyamovie-e99l.onrender.com/".format(FQDN)
else:
    URL = "https://ziyamovie-e99l.onrender.com/".format(FQDN)
