...
URL = "https://ziyamovie.vercel.app".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://ziyamovie.vercel.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://ziyamovie.vercel.app/".format(FQDN)
else:
    URL = "https://ziyamovie.vercel.app/".format(FQDN)
